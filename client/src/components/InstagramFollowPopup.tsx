        ...
        {!showThankYou ? (
          <>
            ...
            <div className="space-y-4 py-4">
              ...
              >
                ...
                />
                <div className="hidden p-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full">
          ...
          <div className="py-8 text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Thanks for following us on Instagram</p>
            </div>
